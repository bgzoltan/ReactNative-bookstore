## First React Native code

## expo used the default Babel configuration so I had to create the babel.config.js and add the plugins section in order to use reaAnimated module correctly
